        ...
        <div class="innerdiv">
            ...
            <div class="rightinnerdiv">
                <div id="addbook" class="innerright portion" style="<?php if (!empty($_REQUEST['viewid'])) {
                    ...
                    <form action="addbookserver_page.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>Branch:<input type="radio" name="branch" value="CSE" />CSE<input type="radio" name="branch" value="ISE" />ISE<div style="margin-left:80px"><input type="radio" name="branch" value="ECE" />ECE<input type="radio" name="branch" value="Other" />Other</div>
                        </div>
            ...
            padding: 8px;'>Issue Name</th><th>Book Name</th><th>Issue Date</th><th>Return Date</th><th>Fine</th></th><th>Issue Type</th></tr>";
                    ...
                    foreach ($recordset as $row) {
                        ...
                        $table .= "<td>$row[8]</td>";
                        $table .= "<td>$row[4]</td>";
                        // $table.="<td><a href='CSEuser_dashboard.php?returnid=$row[0]&userlogid=$userloginid'>Return</a></td>";
                        $table .= "</tr>";
                        // $table.=$row[0];
                    }
                    $table .= "</table>";
